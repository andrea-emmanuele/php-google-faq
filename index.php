<?php
    $fags = [
        ...
        2 => [
                "Perché il mio account è associato a un paese?"  => "Il tuo account è associato a un paese (o territorio) nei Termini di servizio per poter stabilire due cose: <br>
                                                                     <ol>
...
<body>
    <main>
        <section id="fag">
            <?php
                 for ($i=0; $i < count($fags); $i++) {
                     echo "<div class='faq'>";
                     foreach ($fags[$i] as $index => $fag) {
                         echo "<h1>$index</h1>";
                         echo "<p>$fag</p>";
                     }
                     echo "</div>";
